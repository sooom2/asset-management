...
<body>
	...
	<div class="container">
		<form id="iForm" class="form-container">
			<h2 class="tit">
				머니또 커뮤니티<span class="emoji">🍀</span>
			</h2>
...
<!-- 							</div> -->
<!-- 						</td> -->
<%-- 						<td id="board-data" style="text-align: right;">${boardList.member_nickname} --%>
  ...
  <c:forEach items="${boardList}" var="boardList" varStatus="loop">
    <tr>
      ...
      <td id="board-data">${boardList.comm_count}</td>
			...
			<p id="noResultMessage" style="display: none; color: red;">검색 결과가
				없습니다.</p>
		</form>
	</div>
