				...
				<div class="main_area_center">
					<div class="main">
						...
						<div class="order_content_wrapper">
							<ul>
								<li class="order_card"><div
										class="card_cont deal_card_cont">
										<ul class="item_list">
											...
											<div>
												<ul class="pay_method_list item_pay_method_list">
													<div class="other_wrapper_div">
														<ul>
															<li><div
																	...
																	<div class="info">
																		<label for="EasyBank" class="radio_desc">간편
																			계좌이체</label>
																	</div>
																	<div class="exp"></div>
																</div></li>
															<li><div
																	class="wrapper_div other_wrapper_div_option">
																	<div class="info">
													...
													<div class="other_wrapper_consignment">
														<span>간편 계좌이체 수수료 : 1.9%</span>
														<div class="wrapper_div bank_list">
															<div class="info">
																<div class="available_check_box">이용가능 은행 확인</div>
																<div class="available_check_list">
																	<div>이용가능 은행</div>
																	<div>경남은행, 국민은행, 광주은행, 기업은행, 대구은행, 부산은행, 산업은행,
																		새마을, 신협, 씨티은행, 우체국, 전북은행, KEB하나은행, NH농협, SC은행</div>
																	<div>* 우리은행, 카카오뱅크, 케이뱅크 준비중</div>
																</div>
															</div>
														</div>
													</div>
												</ul>
												<div class="wrapper_receipt_main item_wrapper_receipt_main">
													<div class="wrapper_receipt_box">
														<div
															class="wallet_wrapper receipt_wrapper receipt_not_click">
															<ul class="pay_method_list item_pay_method_list">
																			...
																			<div
																				...
																				<div class="swiper_image_wrapper"
																					...
																					<div class="swiper_account_wrapper active"
																						...
																						<a
																							href="/m/payment/account/form?itemIdx=177802504"><div
																								class="easybank_box easybank_new_box">
																								<div>
																									...
																									<div class="easybank_new_title">계좌등록</div>
																								</div>
																							</div></a>
																					</div>
																				</div>
																				<div class="swipe_button_wrapper"
